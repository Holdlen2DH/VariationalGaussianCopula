...
%  True SN Posterior
trueModel = 'SkewNormal';
fix.snMu = 0;  fix.snSigma = 1; fix.snAlpha = 5;
inferModel ='MVNdiag';
...
%%  Plot
figplot.nb = 100;  figplot.Seqx = linspace(-5, 5, figplot.nb)';
figplot.log_pM =  logmodel(figplot.Seqx, trueModel, fix);
trueModel2 = 'SkewNormal';
fix2.snMu = opt.PsiPar(1) ;  fix2.snSigma = opt.PsiPar(2) ; fix2.snAlpha =0; fix2.c = 1;
